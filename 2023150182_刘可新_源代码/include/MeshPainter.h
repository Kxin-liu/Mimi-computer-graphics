...
public:
	...
	// 更新指定索引的纹理
	void updateTexture(int index, const std::string &texture_image);
	...
	void bindObjectAndData2(TriMesh *mesh, openGLObject &object, const std::string &vshader, const std::string &fshader2, const std::string &texture_image = "");
	...
	void addMesh2( TriMesh* mesh, const std::string &name, const std::string &vshader, const std::string &fshader2, const std::string &texture_image = "" );

	// 绘制物体
    void drawMesh(TriMesh* mesh, openGLObject &object, Light *light, Camera* camera);
	void drawMesh(int i, glm::mat4 modelMatrix, Light *light, Camera* camera, int isShadow);
	void drawMesh2(int i, glm::mat4 modelMatrix, Light *light, Camera* camera, int isShadow);
